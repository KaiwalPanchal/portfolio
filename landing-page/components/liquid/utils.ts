...
export function getShaderColorFromString(colorString: any, fallback = [0, 0, 0, 1]): number[] {
    ...
    if (colorString.startsWith("#")) {
        ...
        // Simple fallback for named colors not implemented here, or return fallback
        // For accurate named colors, a canvas context check could be used, but keeping it simple for now.
...
// Simplified hook to just return colors as array
export function useColors(color1: string, color2: string, color3: string) {
