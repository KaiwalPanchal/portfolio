...
import { useEffect, useRef, startTransition, type CSSProperties } from "react"
...
addPropertyControls(ShaderFlow, {
    xScale: {
        type: ControlType.Number,
        title: "X Scale (Shader Flow)",
        defaultValue: 1.0,
        min: 0.1,
        max: 5.0,
        step: 0.1,
